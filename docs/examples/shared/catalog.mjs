import { readData } from '../../../playground/wasm.mjs?v=0.2.0';
const data = await readData(new URL('./catalog.json?v=0.2.0', import.meta.url));
const freeze = value => { if (value && typeof value === 'object') { Object.values(value).forEach(freeze); Object.freeze(value); } return value; };
export const { fish: FISH, rods: RODS, baits: BAITS, fields: FIELDS, shapes: SHAPES, patterns: PATTERNS } = freeze(data);
